...
## Raw shadow sampling
Focusing primarily on the sampling, the naïve way is by taking one sample of the shadow map.
...
Using this method, we end up with these jagged shadows shown in the image below.
![Raw sample](/assets/images/posts/2026-06-07-vogel/raw_sampling.png)
...
![PCF sample](/assets/images/posts/2026-06-07-vogel/pcf_sampling.png)
...
It works by placing *n* sample points in a disc, where each point *i* sits at radius $\sqrt{(i + 0.5) / n}$ and angle $i \cdot \phi_g + \phi$. Here $\phi_g \approx 2.4$ radians is the [golden angle](https://en.wikipedia.org/wiki/Golden_angle), derived from the golden ratio. The golden angle ensures consecutive points are never clustered together, producing a near-uniform distribution over the disc area without the axis-aligned regularity of a grid.

![vogel](/assets/images/posts/2026-06-07-vogel/vogel_disc.png)
...
![Vogel Sampling](/assets/images/posts/2026-06-07-vogel/vogel_sampling.png)
---
...
![Vogel-disc Soft Shadows](/assets/images/posts/2026-06-07-vogel/VDFSS.png)
